/**
 * SupplierImportPage
 * Three-stage bulk import wizard for supplier products.
 *
...
const DEFAULTS_STORAGE_KEY = 'ballers_supplier_import_defaults';
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p id="confirm-dialog-desc" className="text-sm text-ink-muted mt-1">
              ...
              This will fetch each category from the supplier, parse album data,
              and create new products in your store. Existing products with
...
function SupplierImportPage() {
  ...
  const fetchCategories = useCallback(
    async (forceRefresh = false) => {
      ...
      try {
        const { categories: cats, cachedAt } = await getSupplierCategories(forceRefresh);
        setCategories(cats);
